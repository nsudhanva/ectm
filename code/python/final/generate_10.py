...
with open("../../../data/final/10.csv", "w") as csv_file :
        ...
        for month in range(1, 61):
            ...
            if month == 1:
                ...
                if month == 23 :
                    ...
                    body[engine_no][month]['ff'] = np.random.randint(prev_ff+100, 6000)
                    body[engine_no][month]['n1'] = np.random.randint(prev_n1+300, 15900)
