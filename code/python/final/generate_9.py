...
with open("../../../data/final/9.csv", "w") as csv_file :
        ...
        for month in range(1, 61):
            ...
            if month == 1:
                ...
                if month == 6 :
                    ...
                    body[engine_no][month]['egt'] = np.random.randint(prev_egt+200, 2700)
                    body[engine_no][month]['ff'] = prev_ff + np.random.randint(37, 42)
                    body[engine_no][month]['n1'] = np.random.randint(prev_n1+300, 15000)
                    body[engine_no][month]['n2'] = np.random.randint(prev_n2+300, 13800)
