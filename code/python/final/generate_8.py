...
with open("../../../data/final/8.csv", "w") as csv_file :
        ...
        for month in range(1, 61):
            ...
            if month == 1:
                ...
                if month == 20 :
                    ...
                    body[engine_no][month]['egt'] = np.random.randint(prev_egt+200, 2300)
                    body[engine_no][month]['ff'] = np.random.randint(prev_ff+50, 5800)
