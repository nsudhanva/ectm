...
with open("../../../data/final/3.csv", "w") as csv_file :
        ...
        for month in range(1, 61):
            ...
            if month == 1:
                ...
                if month == 25 :
                    ...
                    body[engine_no][month]['ff'] = np.random.randint(prev_ff+100, 5900)
                    body[engine_no][month]['n1'] = np.random.randint(prev_n1+300, 15300)
                    body[engine_no][month]['n2'] = np.random.randint(prev_n2+300, 13300)
