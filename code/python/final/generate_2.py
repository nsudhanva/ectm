...
with open("../../../data/final/2.csv", "w") as csv_file :
        ...
        for month in range(1, 61):
            ...
            if month == 1:
                ...
                if month == 8 :
                    ...
                    body[engine_no][month]['noise'] = np.random.randint(prev_noise+1, 141)
                    body[engine_no][month]['egt'] = np.random.randint(prev_egt+200, 2500)
                    body[engine_no][month]['ff'] = np.random.randint(prev_ff+100, 5850)
                    body[engine_no][month]['n1'] = np.random.randint(prev_n1+300, 15150)
                    body[engine_no][month]['n2'] = np.random.randint(prev_n2+300, 13150)
