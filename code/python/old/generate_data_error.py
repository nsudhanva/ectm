...
with open("../../data/engine_data_error.csv", "w") as csv_file :
    ...
    for engine_no in range(1, 101):
        ...
        for month in range(1, 61):
            ...
            if month == 1:
                ...
                body[engine_no][month]['egt'] = 1500 + np.random.randint((month-1)*11, month*11)
                body[engine_no][month]['ff'] = 5200 + np.random.randint((month-1)*9, month*9)
                body[engine_no][month]['n1'] = 13000 + np.random.randint((month-1)*35, month*35)
                body[engine_no][month]['n2'] = 11000 + np.random.randint((month-1)*35, month*35)
