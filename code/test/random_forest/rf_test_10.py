...
dataset = pd.read_csv('../../../data/test_data/test_data_10.csv')
...
with open('../../../models/random_forest/rf_noise.pkl', 'rb') as f:
...
dataset['rf_fp_noise'] = y_pred_noise
...
# Loading and fitting the regression model
with open('../../../models/random_forest/rf_egt.pkl', 'rb') as f:
    regressor = pickle.load(f)
...
# Loading and fitting the regression model
with open('../../../models/random_forest/rf_ff.pkl', 'rb') as f:
    regressor = pickle.load(f)
...
# Loading and fitting the regression model
with open('../../../models/random_forest/rf_n1.pkl', 'rb') as f:
    regressor = pickle.load(f)
...
# Loading and fitting the regression model
with open('../../../models/random_forest/rf_n2.pkl', 'rb') as f:
    regressor = pickle.load(f)
...
dataset['rf_fp_n2'] = y_pred_n2

# ==================================
#        Failure Probability
# ==================================

X_data = dataset.loc[:, ['month', 'noise', 'egt', 'ff', 'n1', 'n2', 'rf_fp_noise', 'rf_fp_ff', 'rf_fp_egt', 'rf_fp_n1', 'rf_fp_n2']]
X = X_data.values
...
# Loading and fitting the regression model
with open('../../../models/random_forest/rf_total_fp.pkl', 'rb') as f:
    regressor = pickle.load(f)
...
dataset['rf_total_fp'] = y_pred

# Writing to csv file
dataset.to_csv('../../../data/test_data/test_data_10.csv', index=False)
...
plt.show()
plt.savefig('../../../outputs/random_forest/rf_test_10.png')
