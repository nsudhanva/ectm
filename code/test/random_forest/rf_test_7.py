...
dataset = pd.read_csv('../../../data/test_data/test_data_7.csv')
...
# Writing to csv file
dataset.to_csv('../../../data/test_data/test_data_7.csv', index=False)
...
plt.show()
plt.savefig('../../../outputs/random_forest/rf_test_7.png')
